...
{% capture solution2020-1-3 %}
**Solution**  

![2020-1 3 Solution]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-1-3-sol.drawio.svg)  

{% endcapture %}

<div class="notice--warning">{{ solution2020-1-3 | markdownify }}</div>  
...
{% capture solution2020-1-4 %}
**Solution**  

![2020-1 4 Solution]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-1-4-sol.drawio.svg)  

{% endcapture %}

<div class="notice--warning">{{ solution2020-1-4 | markdownify }}</div>  
...
![2020-1 5]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-1-5.drawio.svg){: .align-center}
 ...
 {% capture solution2020-1-5 %}
**Solution**  

**A.** one hold violation path: x0 (0) → FF0_Q (0.5) → OR → FF0_D (2.0) < T_HOLD (2.2)  

Fix:  

![2020-1 5 Solution]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-1-5-sol.drawio.svg)  

**B.**  

Critical path: x1 → FF1_Q (0.5) → D_MAX (5.5) → AND (7.5)  

Setup time: 1.5  

→ Minimal clock period: 9.0

{% endcapture %}

<div class="notice--warning">{{ solution2020-1-5 | markdownify }}</div>  
...
{% capture solution2020-2-1 %}
**Solution**  

![2020-2 1 Solution]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-2-1-sol.drawio.svg)  

{% endcapture %}

<div class="notice--warning">{{ solution2020-2-1 | markdownify }}</div>  
...
{% capture solution2020-2-3 %}
**Solution**  

![2020-2 3 Solution]({{site.baseurl}}/assets/images/2024-03-04-logic-design-2020-2-3-sol.drawio.svg)  

{% endcapture %}

<div class="notice--warning">{{ solution2020-2-3 | markdownify }}</div>  
