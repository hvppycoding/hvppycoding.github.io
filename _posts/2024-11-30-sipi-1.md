...
분석하기 위해 eye diagram을 많이 사용한다. Unit interval 기준으로 신호를 겹쳐서 보고 worst case를 확인할 수 있다. {: .notice--info}
...
더 나아가서 SI 엔지니어가 해야하는 것 중 중요한 일은 Root cause를 찾아내는 것이다. 원인을 찾아내는 방법 중 하나가 Cross Talk 분석이다. Cross Talk 파형이 예상 파형을 생각할 수 있고 이를 확인할 수 있다. {: .notice--info}
